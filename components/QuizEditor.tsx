...
import { SavedQuiz, QuizQuestion, MnemonicRule } from '../types.ts';
    ...
    <>
          ...
          <div className="flex justify-between items-center mb-6">
            ...
            <div className="flex items-center gap-2">
                ...
                <button
                    ...
                    className="inline-flex items-center justify-center gap-2 px-3 py-2 border border-purple-300 dark:border-purple-600 text-sm font-bold rounded-md text-purple-600 dark:text-purple-300 bg-purple-50/50 dark:bg-purple-900/30 hover:bg-purple-100 dark:hover:bg-purple-800/50 transition-colors"
                >
      ...
      {isAddingManually && (
          <QuestionEditorModal
            ...
            totalQuestions={editedQuiz.questions.length}
            onSave={(newQuestion, position) => {
                const newQuestions = [...editedQuiz.questions];
                // position is 1-based, index is 0-based.
                const index = (position !== undefined && position >= 1 && position <= newQuestions.length + 1)
                    ? position - 1
                    : newQuestions.length;
